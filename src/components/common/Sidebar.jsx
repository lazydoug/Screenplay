  ...
  const drawer = (
    <>
      ...
      <List sx={{ paddingX: '30px' }}>
        ...
        {user && (
          <>
            <Typography variant='h6' marginTop='20px' marginBottom='5px'>
              PERSONAL
            </Typography>
        ...
        <ListItemButton
          ...
          <ListItemIcon>
            {themeMode === themeModes.dark && <Sun variant='Broken' />}
            {themeMode === themeModes.light && <Moon variant='Broken' />}
          </ListItemIcon>
          <ListItemText
            disableTypography
            primary={
